<?php include_once('header.php'); ?>
    ...
    <main>
        <section class="market repeated_3">
            ...
            <h2>Bądź na bieżąco z najnowszymi zmianami na rynku finansowym i zawieraj przemyślane transakcje.
            </h2>
        ...
        <section class="analytics_graphs">
            <article class="econoimic graph-standart">
                <h2>Kalendarz ekonomiczny dla traderów forex</h2>
                <p>Obowiązkową częścią strategii profesjonalnego tradera jest plan handlowy. Dzięki kalendarzowi ekonomicznemu możesz planować transakcje co do minuty, biorąc pod uwagę nadchodzące raporty ekonomiczne, konsensus prognoz i szacowaną zmienność.
                </p>
            ...
            <article class="market-condition graph-standart">
                ...
                <p>Aktualny stan rynku instrumentów finansowych na rynku. Pozwala poznać cenę dla określonego czasu i zobaczyć dynamikę dla różnych okresów.
                </p>
            ...
            <article class="data ">
                <div class="data_leaders ">
                    ...
                    <p>Podejmuj szybkie decyzje handlowe dzięki wskaźnikom liderów rynku.
                    </p>
                ...
                <div class="data_fundamental ">
                    ...
                    <p>Kopnij opony w podstawy dzięki temu szczegółowemu badaniu, w jaki sposób firma radzi sobie poza samą ceną akcji.
                    </p>
            ...
            <article class="real-time graph-standart">
                <h2>Wykresy handlowe w czasie rzeczywistym
                </h2>
                <p>Skorzystaj z głównego narzędzia handlowców - analizy technicznej na wykresie instrumentu finansowego.
                </p>
            ...
            <article class="forex graph-standart">
                <h2>Kursy krzyżowe Forex
                </h2>
                <p>Ten pozwala wyświetlać w czasie rzeczywistym notowania wybranych walut w porównaniu z innymi głównymi walutami.</p>
        ...
        <section class="analytic_baner repeated_2 ">
            <div class="repeated_2_left">
                ...
                <div class="repeated_2_left-text">
                    ...
                    <h3>Otwarte transakcje z zyskiem</h3>
                </div>
            </div>
            <div class="repeated_2_right">
                <p>Handluj i inwestuj w akcje, waluty, indeksy i towary (kontrakty CFD).</p>
            </div>
        </section>
